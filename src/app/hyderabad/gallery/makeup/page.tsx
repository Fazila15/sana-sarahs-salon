...
const PRICE_MAP: Record<Category, { actual: string; discount?: string }> = {
  "signature-by-sana-sarah": { actual: "PKR 200,000" },
  "signature-artist": { actual: "PKR 70,000", discount: "PKR 35,000" },
  "senior-artist": { actual: "PKR 50,000", discount: "PKR 25,000" },
  "expert-artist": { actual: "PKR 30,000", discount: "PKR 15,000" },
};

export default function HyderabadMakeupCatalogue() {
    ...
    <div className="min-h-screen text-white">
      <header className="border-b border-white/10 bg-black/30 backdrop-blur">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-4 flex justify-between">
          <h1 className="text-lg font-semibold">Hyderabad — Makeup Catalogue</h1>
          <Link
            href="/hyderabad"
