...
const SKINCARE_VIDEO = {
  file: "/gallery/skincare/1",
  title: "Overall Skincare Services",
};
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 py-10">
        ...
        >
          <p className="text-xs text-white/60 uppercase tracking-widest">
            Sana Sarah's Salon & Studio— Skincare Gallery
          </p>
        ...
        {/* Single Video */}
        <div
          className="cursor-pointer relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] max-w-3xl mx-auto"
          onClick={() => setOpen(true)}
        >
          <video
            src={`${SKINCARE_VIDEO.file}.mp4`}
            loop
            muted
            autoPlay
            playsInline
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent opacity-0 hover:opacity-100 transition" />
          <p className="absolute bottom-3 left-3 text-sm font-medium">
            {SKINCARE_VIDEO.title}
          </p>
        </div>
