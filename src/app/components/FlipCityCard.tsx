...
export default function FlipCityCard({
  ...
  const isSingleCity = !branches || branches.length === 0;
  ...
  return (
    <div
      ...
      onClick={() => setFlipped((p) => !p)} // for mobile tap toggle
    >
      <motion.div
      ...
      >
        ...
        {/* BACK */}
        <div className="absolute inset-0 [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-2xl border border-white/10 bg-gradient-to-br from-fuchsia-800/20 to-pink-800/10 backdrop-blur-lg p-5 overflow-y-auto">
