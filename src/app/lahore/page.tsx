...
export default function LahoreBranchMain() {
  const branch = {
    name: "Lahore",
    address:
      "House #82 - Block B2, Gulberg III, Main MM Alam Road, Opposite OD, Lahore, Pakistan",
    phones: ["+92 42 37881450", "+92 334 0654474"],
    mapEmbed: (
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13605.344420505554!2d74.3450006!3d31.5086519!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2ec70fb2107e92ab%3A0xcec8aa1cd586b914!2sSana%20Sarah's%20Salon%20%26%20Studio%20Lahore%20Branch!5e0!3m2!1sen!2s!4v1730916457712!5m2!1sen!2s"
        width="100%"
        height="260"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <span className="block text-[10px] sm:text-xs tracking-widest text-white/60">
                SANA SARAH'S SALON & STUDIO— LAHORE
              </span>
      ...
      <main className="relative z-10">
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          >
            ...
            <h2 className="mt-2 text-3xl sm:text-4xl font-bold">Lahore Branch</h2>
          </motion.div>
