      ...
      <main className="relative z-10">
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="min-h-[calc(100svh-120px)] flex flex-col items-center justify-center py-10 sm:py-16">
            ...
            >
              <OptionCard href="/lahore/ratelist" title="Rate List" desc="See prices for Lahore" Icon={ListChecks} />
              <OptionCard href="/lahore/current-deals" title="Current Deals" desc="Exclusive Lahore offers" Icon={Tag} />
              <Link
                href={`https://wa.me/${encodeURIComponent(WHATSAPP)}?text=${encodeURIComponent(
                  "Hi Sana Sarah Salon, I need assistance for Lahore."
                )}`}
                target="_blank"
